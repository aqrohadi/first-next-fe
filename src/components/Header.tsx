  ...
  return (
    <header className="flex flex-col w-full">
        ...
        <div className="logo-contianer flex items-center justify-center flex-wrap max-w-[1130px] h-[38px] mx-auto gap-[60px]">
            <Image src="/assets/images/logos/TESLA.svg" alt="clients logo" width={113} height={38} />
            <Image src="/assets/images/logos/Libra 2.svg" alt="clients logo" width={113} height={38} />
            <Image src="/assets/images/logos/Binance logo.svg" alt="clients logo" width={113} height={38} />
            <Image src="/assets/images/logos/Facebook 7.svg" alt="clients logo" width={113} height={38} />
            <Image src="/assets/images/logos/Microsoft 6.svg" alt="clients logo" width={113} height={38} />
        </div>
